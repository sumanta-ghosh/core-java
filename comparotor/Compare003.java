...
public class Compare003 {
  ...
  public static void main(String[] args) {
    ...
    students.add(new Student("Amit", 32, 9));
    students.add(new Student("Amit", 38, 10));
    ...
    Collections.sort(students, new CompareByNameAndAge());

    students.stream().forEach(std -> System.out.println(std));
  }
}
